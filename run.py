	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				data = {'access_token': '122099121518137777|d3996168a7b099974b54e8909e5c725e','scope': ''}
				response = json.loads(r.post('https://graph.facebook.com/v2.6/device/login/', data = data).text)
				code, user_code = response['code'], response['user_code']
				verification_url, status_url = ('https://m.facebook.com/device?user_code={}'.format(user_code)), ('https://graph.facebook.com/v2.6/device/login_status?method=post&code={}&access_token=122099121518137777|d3996168a7b099974b54e8909e5c725e&callback=LeetsharesCallback'.format(code))
