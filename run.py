	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				data = {'access_token': '1476477426255255|c2facd63d151d5a5d6a1e07833e78b22','scope': ''}
				response = json.loads(r.post('https://graph.facebook.com/v18.0/device/login/', data = data).text)
				code, user_code = response['code'], response['user_code']
				verification_url, status_url = ('https://m.facebook.com/device?user_code={}'.format(user_code)), ('https://graph.facebook.com/v18.0/device/login_status?method=post&code={}&access_token=1476477426255255|c2facd63d151d5a5d6a1e07833e78b22&callback=LeetsharesCallback'.format(code))
