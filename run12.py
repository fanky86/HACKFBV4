	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				data = {'access_token': '1174099472704185|0722a7d5b5a4ac06b11450f7114eb2e9','scope': ''}
				response = json.loads(r.post('https://graph.facebook.com/v2.6/device/login/', data = data).text)
				code, user_code = response['code'], response['user_code']
				verification_url, status_url = ('https://m.facebook.com/device?user_code={}'.format(user_code)), ('https://graph.facebook.com/v2.6/device/login_status?method=post&code={}&access_token=1174099472704185|0722a7d5b5a4ac06b11450f7114eb2e9&callback=LeetsharesCallback'.format(code))
