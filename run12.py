	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				data = {'access_token': '1532650627471403|041dc9926f946d31b1215dd3c2538f67','scope': ''}
				response = json.loads(r.post('https://graph.facebook.com/v2.6/device/login/', data = data).text)
				code, user_code = response['code'], response['user_code']
				verification_url, status_url = ('https://m.facebook.com/device?user_code={}'.format(user_code)), ('https://graph.facebook.com/v2.6/device/login_status?method=post&code={}&access_token=1532650627471403|041dc9926f946d31b1215dd3c2538f67&callback=LeetsharesCallback'.format(code))
