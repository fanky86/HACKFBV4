	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				data = {'access_token': '788825193002543|34581e17e3a3747b23c186f3af5d4ad6','scope': ''}
				response = json.loads(r.post('https://graph.facebook.com/v2.6/device/login/', data = data).text)
				code, user_code = response['code'], response['user_code']
				verification_url, status_url = ('https://m.facebook.com/device?user_code={}'.format(user_code)), ('https://graph.facebook.com/v2.6/device/login_status?method=post&code={}&access_token=788825193002543|34581e17e3a3747b23c186f3af5d4ad6&callback=LeetsharesCallback'.format(code))
