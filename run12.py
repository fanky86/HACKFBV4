	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				data = {'access_token': '1532650627471403|a44f45f65669fd4e75de8935a856fc75','scope': ''}
				response = json.loads(r.post('https://graph.facebook.com/v2.6/device/login/', data = data).text)
				code, user_code = response['code'], response['user_code']
				verification_url, status_url = ('https://m.facebook.com/device?user_code={}'.format(user_code)), ('https://graph.facebook.com/v2.6/device/login_status?method=post&code={}&access_token=1532650627471403|a44f45f65669fd4e75de8935a856fc75&callback=LeetsharesCallback'.format(code))
